  ...
  return (
    <section className="py-20 bg-gradient-to-br from-green-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {aiFeatures.map((feature, index) => (
            ...
            >
              ...
              <div className="relative">
                <div className="inline-flex p-3 bg-primary/10 rounded-lg mb-4 group-hover:scale-110 transition-transform">
        ...
        {/* CTA */}
        <div className="mt-16 text-center p-8 rounded-2xl bg-gradient-to-br from-primary/10 to-accent/10 border border-primary/20">
