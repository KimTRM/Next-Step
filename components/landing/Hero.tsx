...
import { fadeInUp, staggerContainer, staggerItem, animationConfig, animationConfigFast, animationConfigSmooth, slideInLeft, slideInRight, glowPulse } from '@/lib/animations';
