...
/**
 * Mentor Dashboard Page Content - NextStep Platform
 * 
 * Mentor-specific dashboard for managing mentees and connection requests
 */
...
import { useMentorProfile, useMentorMentees, useMentorConnectionRequests } from "@/features/mentors/api";
...
export function MentorDashboardPageContent() {
    ...
    const mentees = useMentorMentees(mentorProfile?._id);

    // Get connection requests (when mentor profile is loaded)
    const connectionRequests = useMentorConnectionRequests(mentorProfile?._id);
    ...
    const menteesList = (mentees ?? []).filter((m: Mentee | null): m is Mentee => m !== null);
                                    ...
                                    <div key={request._id} className="p-4 border rounded-lg">
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                <h4 className="font-semibold">{request.job.title}</h4>
