...
const sampleJobs = [
    {
        ...
        description:
            "We are looking for a Senior Frontend Developer with experience in React, TypeScript, and modern web technologies. You will be responsible for building responsive web applications and leading the frontend team.",
    ...
    },
    {
        ...
        description:
            "Seeking an experienced Marketing Manager to develop and execute marketing strategies. Experience with digital marketing, social media, and content creation required.",
        employmentType: "full-time",
        location: "BGC, Taguig",
    ...
    },
    {
        ...
        description:
            "Looking for a creative UX/UI Design Intern to assist with user research, wireframing, and prototyping. Great opportunity to learn and grow in a professional design environment.",
    ...
    },
    {
        ...
        company: "StartupHub",
        description:
            "Need a Full Stack Developer for a 6-month contract project. Must be proficient in MERN stack and have experience with cloud deployment.",
    ...
    },
    {
        ...
        description:
            "Hiring Customer Service Representatives to handle customer inquiries via phone, email, and chat. Excellent communication skills required.",
        employmentType: "full-time",
